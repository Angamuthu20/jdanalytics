				...
				for (var i=0 ; i<dt.length; i ++)
					{
						...
						if (finalResult !== null)
						{
							...
							document.getElementById('ostartdate').innerText = objData["startdate"];
							document.getElementById('oenddate').innerText = objData["enddate"];
				...
				for (var i=0 ; i<dt.length; i ++)
					{
						...
						{
							finalResult = parseInt(objData["sum"]);
							document.getElementById('totalClicks').innerHTML = finalResult.toLocaleString("en");	
						}
						else
						{
				...
				for (var i=0 ; i<dt.length; i ++)
					{
						...
						{
							finalResult = parseInt(objData["sum"]);
							document.getElementById('clickRate').innerHTML = finalResult.toLocaleString("en");	
						}
						else
						{
		...
		for (var i=0 ; i<dt.length; i ++)
			{
				...
				if (finalResult !== null)
				{
					...
					document.getElementById('AmountSpent').innerHTML = finalResult.toLocaleString("en");	
				}
				else
				{
				 	...
				 	for (var index in dt)
						{
							...
							categories[index] ={
								   ...
								   "ctr":Math.round(parseInt(objData["ctr"]),2)
						  ...
						  for (var x = rowcount - 1; x >= 0; x--)
						  {
						   ...
						   if (table1 !== null) {
							...
							for(var j=0;j<lineitems_base[i].length;j++)
							{
								...
								newCell.innerHTML =  parseInt(lineitems_base[i][j]["clicks"]).toLocaleString("en");
								var newCell  = newRow.insertCell(3);
								newCell.innerHTML =  Math.round(parseInt(lineitems_base[i][j]["ctr"]),2).toLocaleString("en");
...
var template =' <div class="infowrap-block dfp-infowrap clearfix"> \
			...
			<div class="col-lg-2"> \
				...
				<h3>Start Date</h3> \
				<p>'+objData["startdate"]+'</p> \
				</div> \
				</div> \
				<div class="col-lg-2"> \
				<div class="bg-gray adserve-first-block adserve-end-date"> \
				<h3>End Date</h3> \
				<p>'+objData["enddate"]+'</p></div>  </div> <div class="col-lg-2"> \
		<div class="bg-gray"> \
		  <h3>Rate</h3> \
		  <p>'+objData["rate"]+'</p> \
		</div> \
	...
	<div class="row sum-five-col adserve-list"> \
	  <div class="col-lg-2"> \
		<div class="info-box"> <span class="info-box-icon bg-green"><img src="img/views.png" alt="Total Impressions"></span> \
		  <div class="info-box-content"> <span class="info-box-text">Impressions</span> <span class="info-box-number" id="dfpImpressions">'+objData["sum"]+'</span> </div> \
		</div> \
	  </div> \
	  <div class="col-lg-2"> \
		<div class="info-box"> <span class="info-box-icon bg-green"><img src="img/clicks.png" alt="Total Clicks"></span> \
		  <div class="info-box-content"> <span class="info-box-text">Clicks</span> <span class="info-box-number" id="dfpClicks">'+objData[""]+'</span> </div>  \
		</div> \
	  </div> \
	  <div class="col-lg-2"> \
		<div class="info-box"> <span class="info-box-icon bg-green"><img src="img/rate.png" alt="Click Through Rate"></span> \
		  <div class="info-box-content"> <span class="info-box-text">Click Through Rate</span> <span class="info-box-number" id="dfpTRate">'+objData[""]+'</span> </div> \
		</div> \
	  </div> \
	  <div class="col-lg-2"> \
		<div class="info-box"> <span class="info-box-icon bg-green"><img src="img/interaction.png" alt="website"></span> \
