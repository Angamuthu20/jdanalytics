					   ...
					   for (var index in dt)
						{
						   ...
						   newCell.innerHTML = '<a  href="'+redirection+'campaignSummaryView.php?lineItem='+objData["urn"]+'&lineItemNew='+objData["urn"]+' " id="'+objData["urn"]+'"  name="'+objData["urn"]+'">'+objData["urn"]+'</a>'; 
							...
							var newCell  = newRow.insertCell(7);
						        newCell.innerHTML =  Math.round(parseInt(objData["ctr"]),2).toLocaleString("en");
					   ...
					   for (var index in dt)
						{
						    ...
						    var newCell  = newRow.insertCell(3);
						    newCell.setAttribute("class", "sticky-cell");
						        newCell.innerHTML = '<a  href="'+redirection+'campaignSummaryView.html?lineItem='+objData["ordername"]+'&lineItemNew='+objData["lineitemname"]+' " id="'+objData["ordername"]+'"  name="'+objData["ordername"]+'">'+objData["ordername"]+'</a>'; 
